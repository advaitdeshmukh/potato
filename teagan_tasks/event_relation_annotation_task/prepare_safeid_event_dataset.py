...
DEFAULT_INPUT = Path("data/dolma_final_sample_s67_n1000_t0.5_llm_summary.csv")
DEFAULT_OUTPUT = Path("data/dolma_final_sample_s67_n1000_t0.5_llm_summary_safeid_with_spans.csv")
