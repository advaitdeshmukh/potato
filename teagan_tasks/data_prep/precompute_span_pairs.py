...
EVENT_TASK = TASKS_DIR / "event_relation_annotation_task"

DEFAULT_CSV = EVENT_TASK / "data" / "dolma_final_sample_s42_n1250_t0.5_llm_summary_safeid_with_spans.csv"
DEFAULT_CONFIG = EVENT_TASK / "config.yaml"
