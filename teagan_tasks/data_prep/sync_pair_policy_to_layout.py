...
# NOTE: this rewrites the served task layout. Do not run it while annotation is
# live -- annotators mid-session would get a changed UI.
ROOT = Path(__file__).resolve().parent.parent / "event_relation_annotation_task"
